# Archived Previous README

Tài liệu này là README của prototype cũ (Next/Prisma/donation tiền) và không còn là đường chạy chính của đồ án hiện tại. README chính xác cho phiên bản MERN tài trợ vật phẩm nằm ở `README.md`.
